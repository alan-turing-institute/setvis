...
# def new_instance(missing_data, selected_data):
#     '''
#     Creates a new MissingDataInstance based on selected fields
#     :param selected_indices
#     :return: a new MissingDataInstance 
#     '''
#     new_missing_data = missing_data
#     # missing_data.

#     return new_missing_data